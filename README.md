...
Публикацию можно сделать любым удобным способом:
через Telethon от имени аккаунта;
через Telegram-бота, если бот добавлен в целевой канал с правами на публикацию.
Видео поддерживать не нужно. Достаточно текста и, если успеете, изображений.
 
⸻
 
Что важно
Интерфейс может быть простым, не нужно делать полноценный продуктовый дизайн. Но он должен быть аккуратным и понятным, не совсем техническая заглушка.
Минимально в интерфейсе должны быть:
...
Главная цель — увидеть рабочую цепочку:
забрали пост → обработали по промпту → опубликовали в другой канал.
